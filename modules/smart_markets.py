    ...
    with col1:
        ...
        if 'df_supplier_kpis' in st.session_state and not st.session_state.df_supplier_kpis.empty:
            ...
            supplier_options = [
                ...
                'Water Systems E', 'Civil Engineering F', 'Laing O\'Rourke', 'Equipment Supplier H'
            ]
...
def render_market_category_intelligence(category, config):
    ...
    with col1:
        view_mode = st.selectbox(
            "View Mode",
            ["📊 Current Intelligence", "📅 Timeline View"],
...
def generate_market_intelligence_report(results):
    """Generate a comprehensive market intelligence report similar to Generic format"""
...
def render_market_challenges_dashboard(market_data):
    """Render the main market challenges dashboard similar to the Generic format"""
...
def render_segmentation_tab():
    ...
    with col2:
        st.markdown("### Generic Market Position")
...
def generate_historical_intelligence_data(category, time_range):
    ...
    suppliers = ["Infrastructure Contractor A", "Engineering Solutions B", "Construction Group C", "Design Build Co D", "Water Systems E", "Civil Engineering F"]
    ...
    for i in range(random.randint(15, 40)):
        ...
        event = {
            ...
            "source": random.choice(["Construction News", "Building Magazine", "Your Water Utility Portal", "Gov.uk", "Company Website"]),
            "category": category,
...
def generate_period_intelligence_data(category, period):
    ...
    period_data = []
    suppliers = ["Infrastructure Contractor A", "Engineering Solutions B", "Construction Group C", "Design Build Co D"]

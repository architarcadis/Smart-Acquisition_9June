...
def render_project_delivery_tab():
    ...
    # Capital Programme delivery overview metrics
    col1, col2, col3, col4 = st.columns(4)
    
    with col1:
        total_value = df['total_value_gbp'].sum() / 1_000_000
        st.metric("Total Capital Programme Value", f"£{total_value:.1f}M")
    ...
    st.markdown("### Capital Programme Contract Delivery Status")
    ...
    with col1:
        ...
        with chart_col:
            ...
            # Ensure proper color mapping by creating a DataFrame with consistent ordering
...
def render_supplier_market_tab():
    ...
    st.markdown("**Supplier capacity and market readiness for Your Water Utility Capital Programme delivery**")
...
def render_contract_pipeline_tab():
    ...
    with col2:
        ...
        with chart_col:
            ...
            df['customer_impact'] = df['total_value_gbp'] / 15_000_000  # Your Water Utility customer base

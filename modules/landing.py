...
def render():
    ...
    # Introduction
    st.markdown("""
### Water Infrastructure Procurement Intelligence

This platform provides water utility procurement leadership with real-time visibility 
into capital programme delivery, ensuring regulatory commitments are met while 
...
oversight of your infrastructure investment programme through integrated 

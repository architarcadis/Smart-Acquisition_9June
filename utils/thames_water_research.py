...
def research_thames_water_amp8():
    """Research Your Water Utility Capital Programme programme data for procurement intelligence"""
    
    scanner = MarketScanner()
    
    # Your Water Utility Capital Programme specific search configuration
    config = {
        'industry_focus': 'Water Infrastructure',
        'geographic_focus': 'UK',
        'company_focus': 'Your Water Utility',
        'programme_focus': 'Capital Programme',
    ...
    # Specific search queries for Your Water Utility Capital Programme
    search_queries = [
        "Your Water Utility Capital Programme Asset Management Programme procurement",
        "Your Water Utility Capital Programme capital investment programme suppliers",
        "Your Water Utility 2025-2030 infrastructure procurement opportunities",
        "Your Water Utility Capital Programme framework agreements contracts",
        "Your Water Utility water treatment procurement Capital Programme",
        "Your Water Utility digital transformation suppliers Capital Programme",
        "Your Water Utility environmental compliance contracts 2025-2030",
        "Your Water Utility infrastructure maintenance framework Capital Programme"
    ]
    
    try:
        # Execute market scan with Your Water Utility specific queries
        results = scanner.execute_market_scan(
            config=config,
            refinement_keywords="Your Water Utility Capital Programme Asset Management Programme procurement contracts suppliers framework",
            num_results=15,
            crawl_depth=1
        )
        ...
        st.error(f"Error researching Your Water Utility Capital Programme data: {str(e)}")
        return []

def generate_thames_water_procurement_data(research_results):
    """Generate Your Water Utility Capital Programme procurement data based on research"""
    ...
    # Generate Your Water Utility Capital Programme Sourcing Pipeline based on real Capital Programme priorities
    sourcing_pipeline = pd.DataFrame({
        'package_name': [
            ...
            'Capital Programme Resilience & Climate Adaptation Programme',
            ...
            'Capital Programme Innovation & Technology Partnership',
    ...
    # Generate Your Water Utility Supplier KPIs based on actual water industry suppliers
    supplier_kpis = pd.DataFrame({
        'supplier_name': [
            'Infrastructure Contractor A',
            'Facilities Management J',
            'Infrastructure Contractor A Living Places',
    ...
    # Generate Your Water Utility Capital Programme Supply Chain Risks
    ...
    # Generate Your Water Utility Team Performance Data
